        ...
        <div class="tabs">
            ...
            <div class="tab-content active" id="imc">
                ...
                <section id="imc-section">
                    ...
                    <p>L'IMC est calculé selon la formule : <strong>poids (kg) / (taille en m)²</strong>.</p>
                    <form id="imc-form">
            ...
            <div class="tab-content" id="img">
                ...
                <section id="img-section">
                    ...
                    <p>L'IMG est une estimation du pourcentage de masse grasse selon la formule de Deurenberg :<br />
            ...
            <div class="tab-content" id="apport">
                ...
                <section id="calories-section">
                    ...
                    <p>Formule de Harris-Benedict (pour le métabolisme de base) ajustée selon le niveau d'activité.</p>
